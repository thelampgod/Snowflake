...
public class GroupInvitePacket extends SnowflakePacket {
    ...
    public GroupInvitePacket(DataInputStream in, ClientHandler sender) throws IOException {
        super(sender);
    ...
    public void handle() throws IOException {
        ...
        final ClientHandler invitedUser = Snowflake.INSTANCE.getServer().getClientReceiver(clientId);
